...
export default class NetworkData {
    ...
    constructor(lobbyId: string, clientId: string, lastPosition: Vector, lastDirection: Vector, sequence: number, ignoreClientMovement: boolean, appliedAuthoring: boolean, positionBuffer: PositionBuffer[], reconciliationMovement: MovementData[]) {
