...
export default class NetworkData {
    ...
    sequence: number;
    forceAuthoring: boolean;
    positionBuffer: PositionBuffer[];
    reconciliationMovement: MovementData[];
    constructor(lobbyId: string, clientId: string, lastPosition: Vector, lastDirection: Vector, sequence: number, forceAuthoring: boolean, positionBuffer: PositionBuffer[], reconciliationMovement: MovementData[]) {
