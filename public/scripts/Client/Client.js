...
var Client = /** @class */ (function () {
    function Client(name, lobbyId, clientId, team, position) {
        ...
        this.networkData = new NetworkData_1.default(lobbyId, clientId, new Vector_1.default(this.position.x, this.position.y), new Vector_1.default(this.direction.x, this.direction.y), 0, [], []);
