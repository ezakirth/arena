...
},{"./transport":16,"./transports/index":17,"component-emitter":12,"debug":23,"engine.io-parser":25,"indexof":30,"parseqs":34,"parseuri":35}],16:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"component-inherit":13,"debug":23,"engine.io-parser":25,"parseqs":34,"xmlhttprequest-ssl":22,"yeast":49}],21:[function(require,module,exports){
(function (Buffer){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"buffer":3,"component-inherit":13,"debug":23,"engine.io-parser":25,"parseqs":34,"ws":2,"yeast":49}],22:[function(require,module,exports){
...
},{"./on":38,"./socket":39,"backo2":8,"component-bind":11,"component-emitter":12,"debug":41,"engine.io-client":14,"indexof":30,"socket.io-parser":44}],38:[function(require,module,exports){
...
},{"./on":38,"component-bind":11,"component-emitter":12,"debug":41,"has-binary2":28,"parseqs":34,"socket.io-parser":44,"to-array":48}],40:[function(require,module,exports){
...
},{"./debug":42,"_process":5,"dup":23}],42:[function(require,module,exports){
arguments[4][24][0].apply(exports,arguments)
},{"dup":24,"ms":33}],43:[function(require,module,exports){
/*global Blob,File*/
...
},{"./binary":43,"./is-buffer":45,"component-emitter":12,"debug":46,"isarray":31}],45:[function(require,module,exports){
(function (Buffer){
...
arguments[4][23][0].apply(exports,arguments)
},{"./debug":47,"_process":5,"dup":23}],47:[function(require,module,exports){
arguments[4][24][0].apply(exports,arguments)
},{"dup":24,"ms":33}],48:[function(require,module,exports){
...
var Bullet = /** @class */ (function () {
    function Bullet(lobbyId, clientId, targetTeam, position, direction, type) {
...
},{"../common/Vector":64}],51:[function(require,module,exports){
"use strict";
...
var Clientclientside = /** @class */ (function (_super) {
    ...
    function Clientclientside(name, lobbyId, clientId, team, position) {
...
},{"../common/Vector":64,"./Client":52}],52:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Vector_1 = require("../common/Vector");
/**
...
},{"../common/Vector":64}],53:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Menu":54}],54:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var $ = require('jquery');
var Menu = /** @class */ (function () {
    ...
    Menu.prototype.show = function () {
        ...
        for (var index = 0; index < game.lobbies.length; index++) {
            _loop_1(index);
        }
...
},{"jquery":32}],55:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Network = /** @class */ (function () {
    ...
    Network.prototype.joinGame = function () {
    ...
    Network.prototype.createClient = function (serverData) {
        ...
        game.localClient = game.clients[game.localClientId] = new Client_clientside_1.default(client.name, client.networkData.lobbyId, client.networkData.clientId, client.infos.team, client.position);
    };
    ...
    Network.prototype.updateClient = function (serverData) {
        ...
        for (var clientId in serverClients) {
            ...
            if (!game.clients[clientId]) {
                game.clients[clientId] = new Client_clientside_1.default(serverClient.name, serverClient.networkData.lobbyId, serverClient.networkData.clientId, serverClient.infos.team, serverClient.position);
            }
    ...
    Network.prototype.sendMovementData = function (client) {
        ...
        if (Math.abs(deltaPosition.x) + Math.abs(deltaPosition.y) + Math.abs(deltaPosition.dx) + Math.abs(deltaPosition.dy) > 0) {
            ...
            var movementData = { movement: deltaPosition, sequence: ++client.networkData.sequence, lobbyId: client.networkData.lobbyId };
    ...
    Network.prototype.shootWeapon = function (client) {
        var bullet = new Bullet_1.default(client.networkData.lobbyId, client.networkData.clientId, client.infos.enemyTeam, client.position, client.direction, client.infos.weapon);
    ...
    Network.prototype.updateBullets = function (bullets) {
        for (var _i = 0, bullets_1 = bullets; _i < bullets_1.length; _i++) {
            ...
            if (bullet.clientId != game.localClientId) {
                var newBullet = new Bullet_1.default(bullet.lobbyId, bullet.clientId, bullet.targetTeam, bullet.position, bullet.direction, bullet.type);
...
},{"./Bullet":50,"./Client.clientside":51,"socket.io-client":36}],56:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Vector":64}],59:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Vector_1 = require("./Vector");
...
},{"./Vector":64}],60:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Vector_1 = require("./Vector");
...
},{"./Tile":62,"./Vector":64}],61:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Buffs":56,"./Flags":57,"./Weapons":65}],62:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Game/Game":53,"./Game/Network":55,"./common/Graphics":58,"./common/Input":59,"./common/Map":60,"./common/Pickups":61,"./common/Timer":63}]},{},[66]);
